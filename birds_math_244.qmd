...
# by season 
ggplot(session_data, aes(x = season, fill = bird_interval)) +
  geom_bar(position = "fill") +
  theme_minimal() +
...
#by sea state
ggplot(session_data %>% drop_na(sea_state_description), aes(x = sea_state_description, fill = bird_interval)) +
...
ggplot(session_data, aes(x = bird_interval, y = latitude, fill = bird_interval)) +
