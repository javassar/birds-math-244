...
ggplot(session_data, aes(x = season, fill = bird_interval_four)) +
  ...
  scale_x_discrete(labels= c("Winter" = "Winter, n=4778", "Summer" = "Summer, n=7027",
                             "Spring" = "Spring, n=6894", "Autumn" = "Autumn, n=4683")) +
...
ggplot(session_data %>% drop_na(sea_state_description), aes(x = sea_state_description, fill = bird_interval_four)) +
  ...
  theme_minimal() +
  coord_flip() + 
  scale_x_discrete(labels = c("Very Rough" = "Very Rough, n=780", "Calm, Rippled" = "Calm, Rippled, n=1484",
                              "Moderate" = "Moderate, n=7858", "Rough" = "Rough n=4028",
                              "Slight" = "Slight, n=9231", "Smooth" = "Smooth, n=1")) +
...
Based on these results, **Figure 9** (AUC = 0.6384) performs slightly better than **Figure 10** (AUC = 0.5815). This indicates that the environmental and spatial factors used in this study are better at discriminating between solo birds and small groups than they are at identifying very large flocks.
...
Though this tree has a high success rate, it achieves it through the rather banal approach of classifying nearly every observation as falling within the 0-10 bird interval, and thus it does not seem to truly discriminate flock size well. Rather, the decision tree performs well due to the extreme skew of the data, since a random sample of observations will most likely have this skew as well. 
