...
### Data Cleaning
We choice to exclude observations with missing data to ensure that our exploratory assessments were not distorted. We first removed any observations missing core variables (count, species, coordinates, time). Next, we performed an iterative process:
...
## Modeling Strategy
We focused on classification models to predict bird presence and flock sizes:
...
As observed in @fig-activity-plot, the most frequent bird activities observed include flying past a ship and following the vessel. As we lost most to all of our ship data during data cleaning, however, we felt there was little interpretable incentive to focus in on these activities. Hence, we maintained a broad scope of number of birds. 

### Spatial Distribution

```{r}
#| label: fig-geographic-map
#| fig-cap: "Figure 2. Geographic Distribution of Bird Count Intervals"
ggplot() +
...
#| fig-cap: "Figure 3. Spatial Density of Observations"
ggplot() +
...
#| fig-cap: "Figure 5. DBSCAN Clustering of Sightings"
...
#| fig-cap: "Figure 4. Latitudinal Distribution of Bird Count Intervals"
